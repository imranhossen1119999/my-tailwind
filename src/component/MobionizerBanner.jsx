...
import bg from "../assets/BottomBanner/b-banner-01.png"
const MobionizerBanner = () => {
    return(
      <div className="flex flex-col px-6 md:px-16 items-center justify-center py-16 bg-gray-50 pb-20">
        <div className="flex flex-col md:flex-row w-[100%] justify-center items-center py-6 px-4 rounded-xl text-white bg-cover bg-center" style={{ backgroundImage:`url(${bg})` }}>
